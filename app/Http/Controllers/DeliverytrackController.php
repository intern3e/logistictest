...
class DeliverytrackController extends Controller
{
    ...
    // วิธีการจัดส่ง / ผู้รับผิดชอบ — โหลดจาก config/delivery.php (แชร์กับหน้า billreceive) ใน constructor
    protected array $deliveryMethods = [];
    protected array $responsiblePersons = [];

    public function __construct()
    {
        $this->deliveryMethods    = config('delivery.methods', []);
        $this->responsiblePersons = config('delivery.responsible_persons', []);
    }
