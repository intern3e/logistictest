...
<head>
    ...
    <title>{{ isset($doc) ? 'แก้ไขใบชั่วคราว' : 'สร้างใบชั่วคราว' }}</title>
            ...
            <div class="card area-doc-company">
                <div class="card-head" style="justify-content:space-between;flex-wrap:wrap;">
                    ...
                    <div class="field header-field-date" style="display:flex;flex-direction:row;align-items:center;gap:10px;margin:0;">
                        ...
                        <input type="date" id="datestamp" name="datestamp" value="{{ $doc->datestamp ?? date('Y-m-d') }}" required style="width:160px;">
                    </div>
                    ...
                    <div class="field header-field-doctype" style="margin:0;">
                        <div style="display:flex;flex-direction:row;align-items:center;gap:10px;">
                            ...
                            <select id="doctype" name="doctype" required onchange="toggleOtherInput()" style="flex:1;">
                                <option value="" disabled {{ !isset($doc) ? 'selected' : '' }}>-- กรุณาเลือกประเภทบิล --</option>
                                <option value="รับของ" {{ isset($doc) && $doc->doctype == 'รับของ' ? 'selected' : '' }}>รับของ</option>
                                <option value="ส่งของ" {{ isset($doc) && $doc->doctype == 'ส่งของ' ? 'selected' : '' }}>ส่งของ</option>
                                <option value="รับของและส่งของ" {{ isset($doc) && $doc->doctype == 'รับของและส่งของ' ? 'selected' : '' }}>รับของและส่งของ</option>
                                <option value="ส่งของและรับกลับ" {{ isset($doc) && $doc->doctype == 'ส่งของและรับกลับ' ? 'selected' : '' }}>ส่งของและรับกลับ</option>
                                <option value="อื่นๆ" id="other_option" 
                                    @if(isset($doc) && !in_array($doc->doctype, ['รับของ', 'ส่งของ', 'รับของและส่งของ', 'ส่งของและรับกลับ', 'อื่นๆ'])) 
                                        selected value="{{ $doc->doctype }}"
                                    @elseif(isset($doc) && $doc->doctype == 'อื่นๆ')
                                        selected
                                    @endif>
                                    @if(isset($doc) && !in_array($doc->doctype, ['รับของ', 'ส่งของ', 'รับของและส่งของ', 'ส่งของและรับกลับ', 'อื่นๆ']))
                                        {{ $doc->doctype }}
                        ...
                        <input type="text" id="other_input" name="other_input" 
                            style="display:{{ isset($doc) && !in_array($doc->doctype, ['รับของ', 'ส่งของ', 'รับของและส่งของ', 'ส่งของและรับกลับ', 'อื่นๆ']) ? 'block' : 'none' }};margin-top:8px;" 
                            placeholder="กรุณากรอกข้อมูล" 
                            value="{{ isset($doc) && !in_array($doc->doctype, ['รับของ', 'ส่งของ', 'รับของและส่งของ', 'ส่งของและรับกลับ', 'อื่นๆ']) ? $doc->doctype : '' }}" 
                            oninput="updateOtherOption()">
                    </div>
                </div>
                ...
                <div class="span-full">
                    <div style="display:grid;grid-template-columns:1fr 220px 1.5fr;gap:16px;margin-bottom:16px;">
                        <div class="field">
                            ...
                            <select id="headcom" name="headcom" required onchange="toggleSoBlock()">
                                <option value="" disabled {{ !isset($doc) ? 'selected' : '' }} style="text-align:center;">-- กรุณาเลือกชื่อบริษัท --</option>
                                <option value="บริษัท ทริปเปิ้ล อี เทรดดิ้ง จำกัด" {{ isset($doc) && $doc->headcom == 'บริษัท ทริปเปิ้ล อี เทรดดิ้ง จำกัด' ? 'selected' : '' }} style="text-align:left;">บริษัท ทริปเปิ้ล อี เทรดดิ้ง จำกัด</option>
                                <option value="บริษัท ทริปเปิ้ล อี อินโนเวชั่น จำกัด" {{ isset($doc) && $doc->headcom == 'บริษัท ทริปเปิ้ล อี อินโนเวชั่น จำกัด' ? 'selected' : '' }} style="text-align:left;">บริษัท ทริปเปิ้ล อี อินโนเวชั่น จำกัด</option>
                                <option value="บริษัท ทริบเปิ้ล พี แฟคตอรี่ แอนด์ เอ็นจิเนียริ่ง จำกัด" {{ isset($doc) && $doc->headcom == 'บริษัท ทริบเปิ้ล พี แฟคตอรี่ แอนด์ เอ็นจิเนียริ่ง จำกัด' ? 'selected' : '' }} style="text-align:left;">บริษัท ทริบเปิ้ล พี แฟคตอรี่ แอนด์ เอ็นจิเนียริ่ง จำกัด</option>
                                <option value="บริษัท เอตะ แอนด์ พอล อินโนเวชั่น จำกัด" {{ isset($doc) && $doc->headcom == 'บริษัท เอตะ แอนด์ พอล อินโนเวชั่น จำกัด' ? 'selected' : '' }} style="text-align:left;">บริษัท เอตะ แอนด์ พอล อินโนเวชั่น จำกัด</option>
                                <option value="บริษัท ฮิคาริ เดงกิ จำกัด" {{ isset($doc) && $doc->headcom == 'บริษัท ฮิคาริ เดงกิ จำกัด' ? 'selected' : '' }} style="text-align:left;">บริษัท ฮิคาริ เดงกิ จำกัด</option>
                        ...
                        <div class="field">
                            <label for="cust_code_search">รหัสลูกค้า <span style="color:var(--text-muted);font-weight:400;">(ค้นหา)</span></label>
                            <div style="position:relative;">
                                <input type="text" id="cust_code_search" name="cust_code_search" autocomplete="off" placeholder="กรอกรหัสลูกค้าเพื่อค้นหา" value="{{ $doc->id_com ?? '' }}">
                                <ul id="cust_code_autocomplete" class="autocomplete-list" style="display:none;"></ul>
                            </div>
                        </div>
                        ...
                        <div class="field">
                            ...
                            <div style="position:relative;">
                                <input type="text" id="com_name" name="com_name" autocomplete="off" placeholder="พิมพ์ชื่อบริษัทอย่างน้อย 3 ตัวอักษร" value="{{ $doc->com_name ?? '' }}">
                        ...
                        <div class="span-full so-contact-row">
                            <div class="field" id="so_block" style="display:none;">
                                ...
                                <div class="coords-row">
                                    <input type="text" id="so_num" name="so_num" placeholder="เช่น 69/012494" value="{{ $doc->so_id ?? '' }}">
                                    <button type="button" class="btn-custom" onclick="fetchSODetail()">ค้นหา</button>
                                </div>
                            </div>
                            <input type="hidden" id="so_id" name="so_id" value="{{ $doc->so_id ?? '' }}">

                            <div class="field">
                                <label for="contact_name">ชื่อผู้ติดต่อ <span class="req">*</span></label>
                                <input type="text" id="contact_name" name="contact_name" value="{{ $doc->contact_name ?? '' }}">
                            </div>
                            <div class="field">
                                <label for="contact_tel">เบอร์ติดต่อ <span class="req">*</span></label>
                                <input type="text" id="contact_tel" name="contact_tel" value="{{ $doc->contact_tel ?? '' }}">
                            </div>
                        </div>
                    </div>
                    <input type="hidden" id="emp_name" name="emp_name" value="{{ session('emp_name', 'Guest') }}">
                    <input type="hidden" id="id_com" name="id_com" value="{{ $doc->id_com ?? '' }}">
                </div>
            </div>
                    ...
                    <div class="form-grid-2" style="row-gap:10px">
                      ...
                      <div class="field span-full">
                        ...
                        <div class="field span-full">
                            ...
                            <textarea id="notes" name="notes" rows="2">{{ $doc->notes ?? '' }}</textarea>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="submit-row">
                        ...
                        <div class="btn-hint" id="btnHint">
                            ...
                            <span id="btnHintText">{{ isset($doc) ? 'กรุณากรอกข้อมูลที่จำเป็นให้ครบก่อนแก้ไข' : 'กรุณากรอกข้อมูลที่จำเป็นให้ครบก่อนบันทึก' }}</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function toggleSoBlock() {
        ...
        if (headcom === SO_ENABLED_COMPANY) {
            ...
            if (!document.getElementById("so_num").value) {
        ...
        @if(isset($docDetails))
            ...
            if (Array.isArray(existingItems)) {
                existingItems.forEach(item => {
                    addItemRow(item.item_name || '', item.quantity || '0');
                });
            }
        @endif
    });
    ...
    async function autoSelectCustomerByCode(custCode, custNameFallback) {
        try {
            ...
            if (matched) {
                ...
                const addr = [matched.ContAddr1, matched.ContAddr2, matched.ContDistrict, matched.ContAmphur, matched.ContProvince, matched.ContPostCode]
    ...
    function toggleOtherInput() {
        ...
        if (doctype === "อื่นๆ" || (!['รับของ', 'ส่งของ', 'รับของและส่งของ', 'ส่งของและรับกลับ', 'อื่นๆ'].includes(doctype) && doctype !== "")) {
...
<script>
    ...
    async function performSearch(keyword) {
        if (!keyword) return;
        if (searchCache.has(keyword)) { renderResults(searchCache.get(keyword)); return; }
    ...
    function showAutocompleteResults(companies) {
        ...
        companies.forEach(company => {
            ...
            const addr = [company.ContAddr1, company.ContAddr2, company.ContDistrict, company.ContAmphur, company.ContProvince, company.ContPostCode]
                .filter(part => part && part.trim() !== "").join(" ").trim();
...
<script>
    ...
    function openGoogleMaps() {
        ...
        mapWindow = window.open("https://www.google.com/maps/@13.7563,100.5018,14z", "Google Maps", `width=${windowWidth},height=${windowHeight},left=${leftPosition},top=${topPosition}`);
    }
</script>
...
document.getElementById('submitBill').addEventListener('click', async function (event) {
    ...
    itemRows.forEach((row, index) => {
        ...
        if (itemName) { itemsForPdf.push({ item_name: itemName, quantity: itemQuantity }); }
    });

    try {
        const form = document.getElementById('billForm');
        let response = await apiFetch(form.action, {
            method: 'POST',
            body: formData,
        });
        ...
        if (!response.ok) {
            ...
            try {
                ...
                serverMessage = errBody.message || errBody.error || (errBody.errors ? Object.values(errBody.errors).flat().join(', ') : '');
            } catch (parseErr) {
                try { serverMessage = await response.text(); } catch (_) {}
            }
            throw new Error('บันทึกข้อมูลไม่สำเร็จ (HTTP ' + response.status + ')' + (serverMessage ? ' — ' + serverMessage : ''));
        }
...
async function generateAndUploadBillPdf(doc_id, items) {
    ...
    if (!jsPDF || !window.html2canvas) { console.error("ไม่พบ library jsPDF หรือ html2canvas"); return; }
    ...
    let type = doctypeSelect.value === 'อื่นๆ' ? document.getElementById('other_input').value : doctypeSelect.value;
    ...
    async function captureContentWithRows(innerHtml, paddingCss) {
        ...
        wrap.style.width = CONTAINER_WIDTH_CSS + 'px'; wrap.style.background = '#fff';
        wrap.style.fontFamily = "'Sarabun','Arial',sans-serif"; wrap.style.lineHeight = '1.6'; wrap.style.padding = paddingCss;
        wrap.innerHTML = innerHtml; document.body.appendChild(wrap);
        ...
        const rowEls = wrap.querySelectorAll('#billTable tbody tr');
        const rowRectsCss = Array.from(rowEls).map(row => { const r = row.getBoundingClientRect(); return { top: r.top - wrapRect.top, bottom: r.bottom - wrapRect.top }; });
        const headEl = wrap.querySelector('#billTableHead');
        const headRectCss = headEl ? (() => { const r = headEl.getBoundingClientRect(); return { top: r.top - wrapRect.top, bottom: r.bottom - wrapRect.top }; })() : null;
    ...
    async function captureHtmlChunkWithMarker(innerHtml, paddingCss, markerId) {
        ...
        if (markerId) {
            ...
            if (markerEl) { const r = markerEl.getBoundingClientRect(); markerRectCss = { top: r.top - wrapRect.top, left: r.left - wrapRect.left, width: r.width, height: r.height }; }
        }
        const cvs = await html2canvas(wrap, { scale: 2, backgroundColor: '#FFFFFF', useCORS: true });
        wrap.remove();
        let markerRect = null;
        if (markerRectCss) {
            const scale = cvs.width / CONTAINER_WIDTH_CSS;
            markerRect = { top: markerRectCss.top * scale, left: markerRectCss.left * scale, width: markerRectCss.width * scale, height: markerRectCss.height * scale };
        }
    ...
    function computeSafeBoundaries(startY, totalHeight, budgetPx, rowRects) {
        ...
        while (cursor < totalHeight) {
            ...
            if (next >= totalHeight) { boundaries.push(totalHeight); break; }
            for (const r of rowRects) {
                if (next > r.top + 1 && next < r.bottom - 1) { next = r.top; break; }
            }
            if (next <= cursor + 10) { next = cursor + budgetPx; }
...
<div style="display:flex; align-items:flex-start;"><span style="font-weight:700; color:#475569; width:95px; flex-shrink:0; text-align:left;">หมายเหตุ</span><span style="font-weight:700; color:#475569; padding-right:8px;">:</span><span style="flex:1; word-break:break-word; overflow-wrap:break-word;">${escapeHtmlSo(notes) || '-'}</span></div>
    ...
    const tableHtml = `
        <table id="billTable" style="width:100%; border-collapse:collapse; font-size:13px; margin-top:14px; margin-bottom:20px;">
            ...
            <tbody>${cleanTableRowsHtml}</tbody>
        </table>`;
    ...
    const headerZoneHeightPx = Math.min(headerCanvas.height + HEADER_GAP_PX, Math.round(pageHeightPx * 0.42));
    const sigZoneHeightPx = Math.min(sigCanvas.height + SIG_GAP_PX, Math.round(pageHeightPx * 0.18));
    ...
    try {
        const uploadResponse = await apiFetch('{{ route("savebillpdf") }}', { method: 'POST', body: uploadForm });
