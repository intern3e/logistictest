...
<div class="sidebar" id="sidebar">
  ...
  <div class="sb-nav">
    ...
    <a class="sb-item cur" target="_blank" href="{{ route('inventory.vehicles', ['create_by' => $authUser['name'] ?? '']) }}"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z"/></svg>รถบริษัท</a>
  </div>
</div>
