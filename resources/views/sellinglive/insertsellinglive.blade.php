...
.page-header-icon{
  ...
  border-radius:var(--r-md);
  display:flex;align-items:center;justify-content:center;
  box-shadow:0 4px 12px rgba(15,110,86,.25);
  flex-shrink:0;
}
...
.dep-toggle.on-g .dep-toggle-knob,
.dep-toggle.on-b .dep-toggle-knob,
.dep-toggle.on-a .dep-toggle-knob{left:21px}
/* Percent Input */
.pct-wrap{
...
.s-row.total{
  margin-top:6px;padding:14px 0 0;
...
.btn-save:hover{
  ...
  box-shadow:0 6px 18px rgba(15,110,86,.32);
}
...
/* ===== HELP CARD ===== */
.help-card{
  background:linear-gradient(135deg,#EEF6FE,#F0F8FF);
...
<div class="page">
  ...
  <form id="billForm" enctype="multipart/form-data">
    ...
    <input type="hidden" id="hidden-subtotal"   name="subtotal"   value="0">
    <input type="hidden" id="hidden-grandtotal" name="grand_total" value="0">
    <input type="hidden" id="hidden-emp"        name="emp_name"
      ...
      <div class="col-main">
        ...
        <div class="card">
          <div class="card-head">
            ...
            <span class="card-badge badge-required">จำเป็น</span>
          </div>
          <div class="card-body">
            <div class="form-grid-4">
              <div class="field">
                <label>
                  เลขที่ SO
                  <i class="tip" data-tip="รหัส Sales Order จากระบบ">?</i>
                </label>
            ...
            <div class="section-divider" style="padding:0;margin-bottom:14px">
              ...
              <span class="section-divider-label">
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none" style="display:inline;vertical-align:middle;margin-right:4px">
                  ...
                  <path d="M6 4v2.5l1.5 1.2" stroke="#94A3B8" stroke-width="1.2" stroke-linecap="round"/>
                </svg>
                กำหนดอัตรามัดจำ
              </span>
              <div class="section-divider-line"></div>
                  ...
                  <div class="dep-card-info">
                    <div class="dep-ico di-g">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <rect x="2" y="3" width="12" height="10" rx="1.5" stroke="#0F6E56" stroke-width="1.4"/>
                        <path d="M5 3v3M11 3v3M2 8h12" stroke="#0F6E56" stroke-width="1.4" stroke-linecap="round"/>
                      </svg>
                    </div>
                    <div>
                ...
                <div class="dep-card-top">
                  <div class="dep-card-info">
                    <div class="dep-ico di-b">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <circle cx="8" cy="5.5" r="3" stroke="#185FA5" stroke-width="1.4"/>
                        <path d="M2 14c0-3.31 2.69-6 6-6s6 2.69 6 6" stroke="#185FA5" stroke-width="1.4" stroke-linecap="round"/>
                      </svg>
                    </div>
                    <div>
                ...
                <div class="dep-card-top">
                  <div class="dep-card-info">
                    <div class="dep-ico di-a">
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                        <rect x="1" y="5" width="9" height="7" rx="1" stroke="#854F0B" stroke-width="1.4"/>
                        <path d="M10 7l4 2.5V13h-4" stroke="#854F0B" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
                        <circle cx="3.5" cy="13" r="1.2" stroke="#854F0B" stroke-width="1.2"/>
                        <circle cx="12.5" cy="13" r="1.2" stroke="#854F0B" stroke-width="1.2"/>
                      </svg>
                    </div>
                    <div>
                      ...
                      <div class="tbl-empty">
                        <div class="tbl-empty-icon">
                          <svg width="40" height="40" viewBox="0 0 40 40" fill="none">
                            <rect x="8" y="6" width="24" height="28" rx="4" stroke="#CBD5E1" stroke-width="2"/>
                            <path d="M14 14h12M14 20h12M14 26h8" stroke="#CBD5E1" stroke-width="2" stroke-linecap="round"/>
                          </svg>
                        </div>
      ...
      <div class="col-side">
        ...
        <div class="summary-card">
          <div class="summary-head">
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <rect x="2" y="2" width="12" height="12" rx="3" stroke="#0F172A" stroke-width="1.4"/>
              <path d="M5 8h6M5 10.5h4" stroke="#0F172A" stroke-width="1.4" stroke-linecap="round"/>
              <path d="M5 5.5h2" stroke="#0F6E56" stroke-width="1.6" stroke-linecap="round"/>
            </svg>
            สรุปยอดมัดจำ
          </div>
        ...
        <div class="info-card">
          <div class="info-card-head">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <circle cx="7" cy="7" r="5.5" stroke="#475569" stroke-width="1.3"/>
              <path d="M7 5v3l2 1.5" stroke="#475569" stroke-width="1.3" stroke-linecap="round"/>
            </svg>
            รายละเอียดเอกสาร
          </div>
          <div class="info-items">
            <div class="info-item">
              <span class="ik">SO Number</span>
              <span class="iv" id="info-so">—</span>
            </div>
            <div class="info-item">
              <span class="ik">วันที่สร้าง</span>
              <span class="iv" id="info-date">—</span>
            </div>
            <div class="info-item">
              <span class="ik">ผู้สร้างเอกสาร</span>
              <span class="iv" id="info-emp">—</span>
            </div>
            <div class="info-item">
              <span class="ik">สถานะ</span>
              <span class="iv">
                <span class="status-active">
                  <span class="status-dot" style="width:6px;height:6px;background:var(--primary);animation:pulse 2s infinite;border-radius:50%;display:inline-block"></span>
                  รอมัดจำ
                </span>
              </span>
            </div>
        ...
        <div class="help-card">
          <div class="help-card-head">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <circle cx="7" cy="7" r="5.5" stroke="#185FA5" stroke-width="1.3"/>
              <path d="M5.5 5.5C5.5 4.67 6.17 4 7 4s1.5.67 1.5 1.5c0 1-1.5 1.5-1.5 2.5" stroke="#185FA5" stroke-width="1.3" stroke-linecap="round"/>
              <circle cx="7" cy="10.5" r=".6" fill="#185FA5"/>
            </svg>
            วิธีใช้งาน
          </div>
          <div class="help-item">
            <div class="help-num">1</div>
            <span>ตรวจสอบข้อมูลเอกสารและลูกค้าให้ถูกต้อง</span>
          </div>
          <div class="help-item">
            <div class="help-num">2</div>
            <span>เปิดใช้งานประเภทมัดจำที่ต้องการโดยคลิกที่การ์ด</span>
          </div>
          <div class="help-item">
            <div class="help-num">3</div>
            <span>กรอกเปอร์เซ็นต์มัดจำ (0–100%) สำหรับแต่ละประเภท</span>
          </div>
          <div class="help-item">
            <div class="help-num">4</div>
            <span>ตรวจสอบยอดสรุปด้านขวา แล้วกด "บันทึกใบมัดจำ"</span>
          </div>
        </div>
...
function showLoading(msg){
  ...
  document.getElementById('loadingMsg').textContent=msg||'กำลังโหลดข้อมูล...';
}
...
async function fetchSODetails(soNum, billId){
  ...
  try{
    ...
    if(!data.SoDetail){
      hideLoading();
      showToast('ไม่พบข้อมูล SO','ไม่พบข้อมูล SO: '+soNum,'error');
      return;
    }
...
function toggleCard(k){
  ...
  if(active[k]){
    ...
    res.textContent='0.00 บาท';

  } else {
    card.className='dep-card';
    tog.className='dep-toggle';
    inp.disabled=true;
    inp.value='0';
    res.className='dep-result empty';
    res.textContent='ยังไม่เปิดใช้งาน';
  }
  calc();
}
...
document.getElementById('submitBill').addEventListener('click', async function(){
  ...
  if(!soId && !soNum){
    showToast('ข้อมูลไม่ครบ','ไม่พบข้อมูล SO กรุณาโหลดหน้าใหม่','error');
    return;
  }
  if(!soId && soNum){
    document.getElementById('so_id').value=soNum;
  ...
  btn.disabled=true;
  btn.innerHTML=`
    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" style="animation:spin .7s linear infinite">
      <path d="M8.5 2a6.5 6.5 0 0 1 6.5 6.5" stroke="white" stroke-width="2" stroke-linecap="round"/>
    </svg>
    กำลังบันทึก...
  `;
  try{
