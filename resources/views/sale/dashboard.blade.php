...
<body>
    <div class="header d-flex justify-content-between align-items-center">
        <h5>ระบบเปิดบิล</h5>
        <div>
            <span class="me-3">ผู้ใช้: {{ session('so_number', 'Guest') }}</span>
            <a href="insertdata" class="btn btn-secondary me-2">เพิ่มข้อมูล</a>
        ...
        <!-- Filter Section -->
        <form method="GET" action="{{ route('sale.dashboard') }}" class="row mt-3 g-3">
