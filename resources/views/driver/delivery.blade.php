@if (!empty($printMode))
{{-- ============================================================
     โหมดปริ้น (A4 PDF) — เรนเดอร์ผ่าน DeliverytrackController@printGroup
     ใช้ blade ไฟล์เดียวกับหน้าเว็บปกติ ไม่แยกไฟล์ต่างหาก
     ตัวแปรที่ใช้ในโหมดนี้: $date, $box, $printedBy, $printedAt
     ============================================================ --}}
<!DOCTYPE html>
<html lang="th">
<head>
